"""
    Title: RodriguezAlvarado_usersp2.py
...
# Create a new user document and add them to the users collection
new_user = {
    "firstName": "Harry",
    "lastName": "Potter",
    "employeeId": "1013",
...
print(db.users.find_one({ "firstName": "Harry" }))
